...
public class RenderUtil implements Util {
    ...
    public static void drawText(BlockPos pos, String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate((double)(-((double)esohack.textManager.getStringWidth(text) / 2.0)), (double)0.0, (double)0.0);
    ...
    public static void blockEsp(BlockPos blockPos, Color c, double length, double length2) {
        ...
        double y = (double)blockPos.getY() - RenderUtil.mc.getRenderManager().viewerPosY;
    ...
    public static void glBillboard(float x, float y, float z) {
        ...
        GlStateManager.translate((double)((double)x - RenderUtil.mc.getRenderManager().viewerPosY), (double)((double)y - RenderUtil.mc.getRenderManager().viewerPosY), (double)((double)z - RenderUtil.mc.getRenderManager().viewerPosZ));
    ...
    public static void drawSphere(double x, double y, double z, float size, int slices, int stacks) {
        ...
        GL11.glTranslated((double)(x - RenderUtil.mc.getRenderManager().viewerPosX), (double)(y - RenderUtil.mc.getRenderManager().viewerPosY), (double)(z - RenderUtil.mc.getRenderManager().viewerPosZ));
